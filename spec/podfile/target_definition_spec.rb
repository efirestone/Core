  ...
  describe Podfile::TargetDefinition do
    ...
    describe 'Attributes accessors' do
      ...
      it 'returns a unique list of all whitelisted configurations' do
        @parent.all_whitelisted_configurations.should == []
        @parent.whitelist_pod_for_configuration('ObjectiveSugar', 'Release')
        @parent.whitelist_pod_for_configuration('AFNetworking', 'Release')
        @parent.all_whitelisted_configurations.should == ['Release']
        @parent.whitelist_pod_for_configuration('Objective-Record', 'Debug')
        @parent.all_whitelisted_configurations.sort.should == %w(Debug Release)
      end
